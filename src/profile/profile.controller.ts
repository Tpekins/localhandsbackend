...
export class ProfileController {
  ...
  findAll() { return this.profileService.findAll(); }
  ...
  findOne(@Param('id') id: string) { return this.profileService.findOne(+id); }
  ...
  @ApiResponse({ status: 404, description: 'Profile not found.' })
  remove(@Param('id') id: string) { return this.profileService.remove(+id); }
}
